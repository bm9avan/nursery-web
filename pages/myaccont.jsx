...
const myaccont = ({user,logout}) => {
  ...
  return (
    ...
    {user.val && <div className="flex justify-center justify-self-center"><button onClick={logout} className="group relative w-1/3 justify-center rounded-md border border-transparent bg-g-600 py-2 px-4 text-sm font-medium text-white hover:bg-g-700 focus:outline-none focus:ring-2 focus:ring-g-500 focus:ring-offset-2 mr-8 mt-5 ">logout</button></div>}
    </>
  )
}
